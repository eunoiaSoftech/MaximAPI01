...
namespace Eunoia_UM_API.Controllers
{
    ...
    public class ConsignorController : Controller
    {
        ...
        [HttpPost]
        [Route("AddConsignor")]
        public Api_CommonResponse AddConsignor(SupplierModel supplier)
        {
            try
            {
                var supplierID = 0;
                ...
                param[27] = new SqlParameter("@sLongitude", supplier.sLongitude);
                param[28] = new SqlParameter("@sLatitude", supplier.sLatitude);

                DataSet ds = DBOperation.FillDataSet("[dbo].[USP_Master_Consignor_Save]", param);
                if (ds != null && ds.Tables != null && ds.Tables[0].Rows.Count > 0)
                {
                    supplierID = Convert.ToInt32(ds.Tables[0].Rows[0]["ConsignorID"]);
        ...
        public Api_CommonResponse GetSupplier()
        {
            try
            {
                DataSet ds = DBOperation.FillDataSet("[dbo].[USP_Master_Consignor_Get]");
                if (ds != null && ds.Tables != null && ds.Tables[0].Rows.Count > 0)
                {
        ...
        public Api_CommonResponse GetSupplierDetailsForEdit(int supplierId)
        {
            ...
            {
                SqlParameter[] param = new SqlParameter[1];
                param[0] = new SqlParameter("@ConsignorId", supplierId);
                DataSet ds = DBOperation.FillDataSet("[dbo].[USP_Master_Consignor_GetDetailsForEdit]", param);
                if (ds != null && ds.Tables != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    customer.sLongitude = ds.Tables[0].Rows[0]["sLongitude"].ToString();
                    customer.sLatitude = ds.Tables[0].Rows[0]["sLatitude"].ToString();
        ...
        public Api_CommonResponse UpdateSupplierDetails(SupplierModel supplier)
        {
            try
            {
                ...
                param[25] = new SqlParameter("@sLongitude", supplier.sLongitude);
                param[26] = new SqlParameter("@sLatitude", supplier.sLatitude);

                DataSet ds = DBOperation.FillDataSet("[dbo].[USP_MASTER_Consignor_Update]", param);
                if (ds != null && ds.Tables != null && ds.Tables[0].Rows.Count > 0)
                {
                    supplierID = Convert.ToInt32(ds.Tables[0].Rows[0]["ConsignorID"]);
